...
dataset = AntsDataset(csv_file, data_dir, transform=data_transforms)
...
# Train model
final_model, final_loss = fit(model, dataloaders, loss_func, optimizer, scheduler, device, num_epochs=num_epochs, early_stopper=early_stopper)
...
final_model_folder = "../models/cnn_classifier" + str(latest_model_seq)
